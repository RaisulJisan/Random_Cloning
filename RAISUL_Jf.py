...
logo =                                          """            
\033[1;37m  ____       _             _  
\033[1;37m |  _ \ __ _(_) __ _ _   _| |
\033[1;37m | |_) / _` | |/ _` | | | | |
\033[1;37m |  _ < (_| | | (_| | |_| | |
\033[1;37m |_| \_\__,_|_|\__,_|\__,_|_|
\033[1;37m------------------------------------------------
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with raisul(max_workers=30) as raisulworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    raiul = input('Put File Name :')
    print(" ")
    raisul = input('Saving Put File Name :')
    os.system('touch ' +raisul)
    os.system('sort -r '+raisul+' | uniq > '+raisul)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + raisul )
    print(47*'-')
    print("File Saved To :" + raisul )
    print(47*'-')
